...
//			System.out.println(con);
			...
			while(rs.next())
			{
				if(rs.getString("id").equals(req.getParameter("student_id")))
				{
					out.print("<html>");
					out.print("<head>");
					out.print("<style>*{margin : 0; padding : 0;}body{background-color : cyan !important;}</style>");
					...
					if(Integer.parseInt(rs.getString("marks")) >= 70)
					{
